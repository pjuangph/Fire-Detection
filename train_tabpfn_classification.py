...
from lib.evaluation import auto_device, evaluate
...
# ── TabPFN Classification Training ────────────────────────────
...
def write_best_model_config(best: dict[str, Any], checkpoint_path: str,
                            config_path: str = 'configs/best_model_tabpfn_classification.yaml',
                            ) -> str:
...
def main() -> None:
    ...
    print(f'\n  To use in realtime:')
    print(f'    python realtime_tabpfn_classification.py --config {model_config_path}')

    from lib.plotting import plot_convergence_curves
    plot_convergence_curves(
        results_path, out_path='plots/convergence_tabpfn_classification.png',
        title='TabPFN Classifier — Training Convergence')
    print('Done.')
